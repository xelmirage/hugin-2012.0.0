...
void UsageChart::paintEvent(QPaintEvent *e)
{
    QPainter painter;
    painter.begin(this);
...
void UsageChart::resetVariables(QPainter *painter)
{
...
void UsageChart::drawBackground(QPainter *painter)
{
    painter->save();
...
void UsageChart::drawBox(QPainter *painter)
{
    painter->save();
...
void UsageChart::drawText(QPainter *painter)
{
    painter->save();
...
void UsageChart::drawGraph(QPainter *painter)
{
    painter->save();
...
void UsageChart::drawTitle(QPainter *painter)
{
    painter->save();
...
/*!
  ...
  */
void UsageChart::addData(qreal data)
{
