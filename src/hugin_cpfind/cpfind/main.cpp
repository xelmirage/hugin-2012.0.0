...
bool parseOptions(int argc, char** argv, PanoDetector& ioPanoDetector)
{
    try
    {
        ...
        SwitchArg aArgPreAligned("", "prealigned", "Match only overlapping images\trequires a rough aligned panorama. (default: off)",false);
		 SwitchArg aArgGPS("", "gps", "Match with a gps file. (default: off)",false);
        ...
        {
            if(aArgMultiRow.isSet() || aArgPreAligned.isSet()||aArgGPS.isSet())
            {
                std::cout << "ERROR: --linearmatch does not work together with --multirow or --prealigned or --gps." << endl;
                return false;
            };
        ...
        {
            if(aArgLinearMatch.isSet() || aArgPreAligned.isSet()||aArgGPS.isSet())
            {
                std::cout << "ERROR: --multirow does not work together with --linearmatch or --prealigned or --gps." << endl;
                return false;
            };
        ...
        {
            if(aArgLinearMatch.isSet() || aArgMultiRow.isSet()||aArgGPS.isSet())
            {
                std::cout << "ERROR: --prealigned does not work together with --linearmatch or --multirow or --gps." << endl;
                return false;
            };
		...
		if (aArgGPS.isSet())
        {
            if(aArgLinearMatch.isSet() || aArgMultiRow.isSet()||aArgPreAligned.isSet())
            {
                std::cout << "ERROR: --gps does not work together with --linearmatch or --multirow or --prealigned." << endl;
                return false;
            };
			ioPanoDetector.setMatchingStrategy(PanoDetector::GPS);
        };
