...
CPListFrame::CPListFrame(ARLabStitcherwxMainFrame* parent, Panorama & pano)
...
#endif
#ifdef __WXMSW__
	wxIcon myIcon(ARLabStitcherwxApp::Get()->GetXRCPath() + wxT("data/hugin.ico"), wxBITMAP_TYPE_ICO);
#else
